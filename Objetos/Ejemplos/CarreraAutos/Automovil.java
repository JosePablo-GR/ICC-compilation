				...
				switch(opcion){
					...
					case 2:
						...
						if (opcion2 == 'a' || opcion2 == 'A') {
							...
							System.out.print(" Ingresa la cantidad de litros *enteros* que quieras: ");
							opcion = entrada.nextInt();
					...
					case 4:
						...
						System.out.println("Competirás con " + rival);

						carroCero.carreritas(myCar, rival);

						System.out.println("Por haber participado se te rellenará el tanque completo.");
